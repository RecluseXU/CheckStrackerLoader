...
class Conf_ini(object):
    ...
    def __init__(self, run_location):
        ...
        config.read(self.ini_location, encoding='utf-8')
    ...
    def get_last_spide_time(self):
        ...
        '''
        return int(config.get('StrackerLoader', 'last_spide_time'))
    ...
    def get_nexus_account_info(self):
        ...
        '''
        user_name = config.get('NexusAccount', 'user_name')
        user_password = config.get('NexusAccount', 'user_password')
